---
title: "Weekly Practice 1 Solutions"
output: pdf_document
---
...
```{r, echo = T}
# Using a package called here to set a relative path
# As long as you read it in appropriately the rest of the problem will work
img <- read_csv(here("problem_sets/WeeklyPractice/WP1/data/wpData.csv"))
...
a. Misspelling because the number 1 is used instead of a capital I
...
b. Forgot to include the second argument 
...
c. Missing " after the e in George, which means that the string is never unclosed. Missing quotes cause lots of errors and weird behavior. 
