...
FILL IN ANSWER HERE AND DELETE LINE AFTER
...
b. Using R, change the number of subjects to 600 instead of six, adjusting the number of slips of paper in the box appropriately.  
...
Does anything change with Method 1? Which method do you prefer as N gets large?
...
State the sharp null hypothesis for this design. 

FILL IN ANSWER HERE AND DELETE LINE AFTER

Using R (set your randomization start seed to 1234567), show the results of a randomization test of the sharp null hypothesis of no effect of the study program with a balanced design. 
...
Do you believe the program's claims of success? 
